...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    private static final int REORDER_ANIMATION_DURATION = 180;
    ...
    protected void onFinishInflate() {
        ...
        if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)onFinishInflate");
    ...
    public void onClick(View v) {
    	if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)onClick v = " + v + ", v.getTag() = " + v.getTag());
        Object tag = v.getTag();
    ...
    public boolean onLongClick(View v) {
    	if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)onLongClick v = " + v + ", v.getTag() = " + v.getTag());
        Object tag = v.getTag();
        if (tag instanceof ShortcutInfo) {
            ShortcutInfo item = (ShortcutInfo) tag;
            if (!v.isInTouchMode()) {
    ...
    private void positionAndSizeAsIcon() {
        ...
        if (mMode == PARTIAL_GROW) {
            ...
            lp.y = mIconRect.top;
            mContent.setAlpha(0);
            if(LauncherLog.DEBUG_LAYOUT) LauncherLog.d(TAG, "(Folder)positionAndSizeAsIcon: DragLayer.LayoutParams: "+
            		" lp.width = "+mIconRect.width()+
            		", lp.height = "+mIconRect.height()+
            		", lp.x = "+mIconRect.left+
            		", lp.y = "+mIconRect.top);
    ...
    public void animateClosed() {
    	if (LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)animateClosed");
        if (!(getParent() instanceof DragLayer)) return;
    ...
    public boolean acceptDrop(DragObject d) {
    	if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)acceptDrop: DragObject = "+d);
    ...
    public void onDropCompleted(View target, DragObject d, boolean success) {
    	if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)acceptDrop: View = "+target+", DragObject = "+d+", success = "+success);
        if (success) {
    ...
    private void onCloseComplete() {
    	if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)onCloseComplete:  ");
    ...
    public void onDrop(DragObject d) {
    	if(LauncherLog.DEBUG) LauncherLog.d(TAG, "(Folder)onDrop:  DragObject = "+d);
        ShortcutInfo item;
