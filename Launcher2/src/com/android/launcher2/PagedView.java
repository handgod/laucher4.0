...
public abstract class PagedView extends ViewGroup {
    ...
    protected boolean computeScrollHelper() {
        if (mScroller.computeScrollOffset()) {
        	...
        	View whichHostView = getChildAt(mNextPage);
    ...
    protected int getChildOffset(int index) {
        ...
        if (childOffsets != null && childOffsets[index] != -1) {
            ...
            for (int i = 0; i < index; ++i) {
                offset += getScaledMeasuredWidth(getPageAt(i)) + mPageSpacing * 2;
            }
        ...
        case MotionEvent.ACTION_MOVE:
        	if (mTouchState == TOUCH_STATE_SCROLLING) {
        		if (canSendMessage /*&& ! mDragController.isDraging()*/ ) {
                    View currentHostView = getChildAt(mCurrentPage);
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity) {
        ...
        duration = (int)(1.5f * Math.round(1000 * Math.abs(distance / velocity)));
