...
public class FocusHelper {
    ...
    static boolean handleTabKeyEvent(AccessibleTabView v, int keyCode, KeyEvent e) {
        // Handle key event for all screens.
//        if (!LauncherApplication.isScreenLarge()) return false;
        ...
        if (LauncherLog.DEBUG_KEY) {
            LauncherLog.d(TAG, "handleTabKeyEvent: action = " + action + ",tabCount = " + tabCount
                    + ",tabIndex = " + tabIndex + ",handleKeyEvent = " + handleKeyEvent
                    + ",keyCode = " + keyCode + ",v = " + v);
        }
            ...
            case KeyEvent.KEYCODE_DPAD_LEFT:
                if (handleKeyEvent) {
                    ...
                    if (tabIndex > 0) {
                        ...
                        parent.setCurrentTabToFocusedTab();
                    }
                }
                wasHandled = true;
                break;
