...
public abstract class PagedViewWithDraggableItems extends PagedView
    ...
    private void handleTouchEvent(MotionEvent ev) {    	
        ...
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "handleTouchEvent: ev = " + ev + ",action = " + action
                    + ",mTouchState = " + ",mIsDragging = " + mIsDragging + ",mIsDragEnabled = "
                    + mIsDragEnabled + ",mScrollX = " + mScrollX + ",this = " + this);
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "onInterceptTouchEvent: ev = " + ev + ",mScrollX = " + mScrollX + ",this = " + this);
        }
        handleTouchEvent(ev);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
    	if (LauncherLog.DEBUG_MOTION) {
    	    LauncherLog.d(TAG, "onTouchEvent ev = " + ev + ",mScrollX = " + mScrollX + ",this = " + this);
    	}
        handleTouchEvent(ev);
    ...
    public boolean onLongClick(View v) {
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "onLongClick v = " + v + ", v.getTag() = " + v.getTag()
                    + ",v.isInTouchMode() = " + v.isInTouchMode() + ", mNextPage = " + mNextPage
                    + ",isAllAppsCustomizeOpen() = " + mLauncher.isAllAppsCustomizeOpen()
                    + ",workspace isSwitchingState = " + mLauncher.getWorkspace().isSwitchingState());
        }
