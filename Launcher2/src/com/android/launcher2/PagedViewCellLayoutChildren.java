...
public class PagedViewCellLayoutChildren extends ViewGroup {
    ...
    void destroyHardwareLayer() {
    	if (LauncherLog.DEBUG) LauncherLog.d(TAG, "(PagedViewCellLayoutChildren)destroyHardwareLayout");
        setLayerType(LAYER_TYPE_NONE, null);
    }
    void createHardwareLayer() {
    	if (LauncherLog.DEBUG) LauncherLog.d(TAG, "(PagedViewCellLayoutChildren)createHardwareLayer");
