...
public class SearchSettingsImpl implements SearchSettings {
    ...
    public String getDefaultSearchEngineName() {
    	return getSearchPreferences().getString(SearchEngineItemsController.SEARCH_ENGINE_PREF, 
    			SearchEngineItemsController.DEFAULT_SEARCH_ENGINE);
    }
    
    public boolean shouldSyncSearchEngineWithBrowser() {
    	return getSearchPreferences().getBoolean(SearchEngineItemsController.PREF_SYNC_SEARCH_ENGINE, 
    			true);
    }
